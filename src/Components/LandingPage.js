        ...
        <div>
            <header className="d-flex align-items-center" id="home">
                <div className="container" data-aos="fade-right">
                    ...
                    <a href="#" className="btn btn-book-now px-4 mt-4" onClick={handleClick}>Book Now</a>
                </div>
            </header>
            ...
            <section className="section-feedback" id="section-feedback" style={{backgroundImage:{imgbg}, backgroundRepeat: 'no-repeat'}}>
                <div className="header text-center">
                    <h2>Feedback</h2>
                ...
                <div className="container mt-5">
                    <div className="row justify-content-center">
                        ...
                        <div className="col-12 col-md-4 mb-4">
                            <div className="card" style={{color:'red',backgroundColor:'#002E50'}}>
                                <div className="card-body d-flex flex-column align-items-center border feedback-item" data-aos="zoom-in-up">
                                    <div className="profile">
                                        <img src={profile1} alt="" />
                                    </div>
                                    <span>Mamat Alcatroz</span>
                                    <p className="text-center feedback" style={{color:'white'}}>
                                        “ Wow, its a best Hotel ever i visit in My life. Thankyou for the services ”
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="col-12 col-md-4 mb-4">
                            <div className="card"style={{color:'red',backgroundColor:'#002E50'}}>
                                <div className="card-body d-flex flex-column align-items-center border feedback-item" data-aos="zoom-in-up">
                                    ...
                                    <p className="text-center feedback" style={{color:'white'}}>
                                        “ The services in this Hotel very good, here I’m like a princess. ”
                                    </p>
                                </div>
                            </div>
                        </div>
            ...
            <section className="section-help">
                <div className="container d-flex justify-content-center">
                    <div className="btn-container">
                        <button type="button" className="btn btn-i-need-help mr-3" onClick={handleContact}>
                            I Need Help
                        </button>
                        <button type="button" className="btn btn-book-now ml-3" onClick={handleClick}>
                            Book Now
                        </button>
                    </div>
                </div>
